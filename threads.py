...
counter_customers = range(0,400,4)
counter_sales = range(1,400,4)
counter_thread = range(2,400,4)
# print(list(counter_customers))
# print(list(counter_sales))
# print(list(counter_thread))
...
for sale in sales:
  sale_strip = float(sale.strip("$"))
  total_sales += sale_strip
...
for color in colors:
  print(str(color_count(color)) + " " + color + " threads were sold today")
